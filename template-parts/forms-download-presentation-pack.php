<div class="dark-bg">
    <?php if (isset($args['text']) && $args['text'] !== false && !empty($args['text'])) { ?>
        <div class="pb-30px lg:pb-36px text-left text-4"><?php echo $args['text']; ?></div>
    <?php } ?>
    <form data-form-name="download-presentation-pack" class="grid grid-cols-1 gap-x-[26px] gap-y-[20px]">
        ...
        <div class="input-wrapper col-span-1">
            <button type="submit" class="btn bg-white text-black font-gilroy-semi-bold !px-26px !py-22px tracking-[0.84px] uppercase">Download Now</button>
        </div>
    </form>
</div>